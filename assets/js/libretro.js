...
function zipfsInit() {
    ...
    let idx = 0;
    Promise.all([fetch("assets/frontend/bundle.zip.aa"), fetch("assets/frontend/bundle.zip.ab"), fetch("assets/frontend/bundle.zip.ac"), fetch("assets/frontend/bundle.zip.ad")]).then(function (resps) {
...
$(function () {
    $(".tooltip-enable").tooltip({ placement: "right" });
    $(".showMenu").hide();
...
function loadCore(core) {
    var coreTitle = $('#core-selector a[data-core="' + core + '"]').text();
    $("#dropdownMenu1").text(coreTitle);
    console.log('core: ' + core);

    import("./" + core + "_libretro.js")
    .then((script) => {
    ...
    /* var coreTitle = $('#core-selector a[data-core="' + core + '"]')
        .addClass("active")
        .text();
    $("#dropdownMenu1").text(coreTitle);console.log('core: ' + core);
    //return;
    import("./" + core + "_libretro.js")
        .then((script) => {
            script
